...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/LED_ds30F2012.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/LED_ds30F2012.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=30F2012
MP_LINKER_FILE_OPTION=,--script=p30F2012.gld
# ------------------------------------------------------------------------------------
...
dist/${CND_CONF}/${IMAGE_TYPE}/LED_ds30F2012.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/LED_ds30F2012.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
